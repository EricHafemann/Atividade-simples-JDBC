...
public class Motorista extends Usuario {
    ...
    public Motorista(String cidade_base, String cnh, String veiculo, Long id, String nome) {
        super(id, nome);
    ...
    public void exibirInfo ()
    {
        ...
        System.out.println("= Cidade Base: "+getCpf_cnpj());
        System.out.println("= CNH:         "+getEndereco());
