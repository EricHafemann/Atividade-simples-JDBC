...
public class CadastrarCliente {
    ...
    public static void menu () {
        ...
        // Instancia objeto Usuário que vai ser enviadp
        Cliente clienteRequeste = new Cliente(nome, cpf_cnpj, endereco, cidade, estado);
        ...
        try
        {
            Cliente clienteSalvo = clienteService.insertCliente(cliente1);
