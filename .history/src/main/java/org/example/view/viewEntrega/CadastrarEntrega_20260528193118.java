...
public class CadastrarEntrega {
    ...
    public static void menu ()
    {
        ...
        Entrega entrega = new Entrega(pedido,motorista,dataSaida,dataEntrega,StatusEntrega.EM_ROTA);

        try
        {
           entregaService.insertEntrega(entrega); 
        ...
        System.out.println("-- Entrega Cadastrado");
