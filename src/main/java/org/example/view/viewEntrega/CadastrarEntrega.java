...
public class CadastrarEntrega {
    ...
    public static void menu ()
    {
        ...
        System.out.println("Digite a data de Saída da Entrega: (Dia/Mês/Ano)");
        String dataSaidaString = util.lString();

        LocalDate dataSaidaLocal = LocalDate.parse(dataSaidaString, formato);
        Date dataSaida = Date.valueOf(dataSaidaLocal);
        

        System.out.println("Digite a data de Recebimento da Entrega: (Dia/Mês/Ano)");
